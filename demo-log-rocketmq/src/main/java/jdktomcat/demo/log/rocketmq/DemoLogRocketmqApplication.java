...
import jdktomcat.demo.log.rocketmq.domain.OrderPaidEvent;
import jdktomcat.demo.log.rocketmq.domain.ProductWithPayload;
import jdktomcat.demo.log.rocketmq.domain.User;
...
public class DemoLogRocketmqApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(DemoLogRocketmqApplication.class, args);
    }
